            ...
            <div className="relative flex flex-col">
              ...
              <span
                className={StyleHelper.mergeStyles(
                  ...
                  {
                    'text-blue font-bold': isPastStep && isDefaultTheme,
                    'text-neon font-bold': isPastStep && isNeonTheme,
                    'font-bold text-white': isCurrentStep && isSuccessState,
                    'text-pink font-bold': isCurrentStep && isErrorState,
            ...
            {fixedIndex < steps.length && (
              <div
                className={StyleHelper.mergeStyles('h-0 w-full border-t-2 border-dashed transition-colors', {
                  ...
                  'border-gray-300/30': isCurrentOrFutureStep && isDefaultTheme,
