...
import { TUseNeonBackupData, useNeonImportBackup } from '@/hooks/useNeonBackup'
...
export const RestoreBackupStep2 = () => {
  ...
  const handleSubmit = async ({ password }: TFormData) => {
    ...
    try {
      ...
      navigate('/app/settings/backup-and-restore/restore/3')
    } catch {
      reset()
      setError('password', t('passwordError'))
    }
