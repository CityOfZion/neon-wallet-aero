...
import MdContentCopy from '@/assets/images/md-content-copy.svg?react'
import MdContentPasteGo from '@/assets/images/md-content-paste-go.svg?react'
import MdVisibility from '@/assets/images/md-visibility.svg?react'
import MdVisibilityOff from '@/assets/images/md-visibility-off.svg?react'
      ...
      <div className={StyleHelper.mergeStyles('relative w-full', containerClassName)}>
        ...
        <div
          ...
          className={StyleHelper.mergeStyles(
            'bg-asphalt flex w-full cursor-text items-center gap-x-1.5 rounded px-5 font-medium text-white ring-2 ring-transparent transition-colors outline-none placeholder:text-white/50 aria-disabled:cursor-not-allowed aria-disabled:opacity-50',
            {
