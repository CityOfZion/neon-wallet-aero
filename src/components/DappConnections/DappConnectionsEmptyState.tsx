...
export function DappConnectionsEmptyState() {
  ...
  return (
    <section className="bg-dark-grey mx-auto my-5 flex w-full flex-col items-center justify-center rounded-sm p-6">
      <h2 className="mb-6 text-center text-lg font-normal text-gray-100">{t('title')}</h2>
