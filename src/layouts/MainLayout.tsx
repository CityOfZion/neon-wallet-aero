...
export const MainLayout = ({ children, className, ...props }: TProps) => {
    ...
    >
      <div
        ...
        className={StyleHelper.mergeStyles(
          'flex max-h-[37.5rem] min-h-[37.5rem] max-w-[25rem] min-w-[25rem] flex-col overflow-x-hidden overflow-y-auto bg-gray-900 px-5 py-3.5',
