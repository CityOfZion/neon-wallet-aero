...
import { TRootState } from '@/hooks/useRedux'
import { bsAggregator } from '@/libs/blockchainService'
import { TBlockchainServiceKey } from '@/types/blockchain'
import { TMigrationNeo3, TMigrationNeo3Status, TSaveNotification } from '@/types/store'
...
export const waitMigration = createAsyncThunk<void, TMigrationNeo3>(
  ...
  async (pendingMigrationNeo3, { getState, dispatch }) => {
    ...
    ReactQueryHelper.invalidateTransactionQueries({ account: pendingMigrationNeo3.neoLegacyAccount, network })
